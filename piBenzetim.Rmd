...
---
Bu çalışmada, H. Sait Ölmez'in Data İstanbul meetuo etkinliğinde gerçekleştirmiş olduğu "İstatistik: Daha kolay bir yolu var mı?" sunumundan yararlanılmıştır. etkinliğin orjinal kodlarına 
 [şu adresten](https://github.com/solmez/dataistanbul)
ulaşılabilirsiniz.


[Ka|Ve](https://uzay00.github.io/kahve/)
---
...
par(mfrow = c(2, 2))
cat(piHesabi(100),piHesabi(1000),piHesabi(10000),piHesabi(100000))
```
[Ka|Ve](https://uzay00.github.io/kahve/)
